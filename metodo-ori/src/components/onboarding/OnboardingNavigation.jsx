  ...
  return (
    <div className="mt-4 flex flex-col-reverse gap-3 border-t border-[rgba(242,185,104,0.08)] pt-4 sm:flex-row sm:items-center sm:justify-between">
      <div>
        {stepIndex > 0 && step.type !== "success" && stepIndex < totalSteps && (
          <OriButton
            ...
            variant="secondary"
            onClick={onBack}
            className="px-5 py-2.5 text-sm transition duration-300 hover:border-[rgba(242,185,104,0.22)] hover:bg-white/[0.035] hover:text-[rgba(247,234,216,0.9)]"
            style={{
      ...
      <OriButton
        ...
        disabled={!canProceed}
        onClick={onNext}
        className="relative overflow-hidden px-7 py-2.5 text-sm font-semibold disabled:opacity-40"
        style={{
          boxShadow:
