        ...
        <div className="grid gap-5 lg:grid-cols-[1.08fr_0.92fr] lg:items-center">
          <div className="flex flex-col items-center justify-center gap-4 text-center md:py-3 lg:min-h-[500px]">
            <button
              ...
              aria-label={selectedCard ? selectedCard.title : "Preparar carta do dia"}
                ...
                style={{
                  background: oracleLockedToday
                    ...
                    : hasShuffled
                      ...
                      : "rgba(255,255,255,0.026)",
                  border: hasShuffled && !oracleLockedToday
                    ? "none"
                    : "1px solid rgba(242,185,104,0.12)",
                  color: hasShuffled && !oracleLockedToday ? "#160807" : colors.goldSoft,
                  fontWeight: 560,
                }}
              >
                {oracleLockedToday
