const proximoPassoPadrao =
  "O Código das Deusas revelou sua base arquetípica e a direção simbólica da sua imagem.\n\nO próximo passo, no Dossiê ORI, é traduzir essa leitura para sua presença visual real: corpo, coloração, cabelo, beleza, proporção, textura e direção estética aplicada.\n\nEssa próxima etapa não substitui o arquétipo. Ela dá forma ao que ele revelou.";
...
export const reports = {
  ...
  "Guardiã Sensível": {
    ...
    reconhecimento:
      "A Guardiã Sensível nasce de uma combinação profundamente receptiva: a que sente e a que cuida.\n\nPerséfone revela seu mundo interno, sua sensibilidade psíquica e sua capacidade de perceber atmosferas. Deméter traduz essa percepção em cuidado, suporte, proteção e presença afetiva.\n\nJuntas, elas criam uma mulher que não apenas observa o emocional do outro. Ela entra em contato com ele, acolhe e, muitas vezes, tenta sustentá-lo.",
    essencia:
      "A Guardiã Sensível une profundidade emocional e cuidado encarnado.\n\nPerséfone sente o invisível. Deméter responde ao que sente com acolhimento. Essa combinação cria uma mulher que percebe rapidamente quando algo muda no ambiente, quando alguém não está bem ou quando uma emoção foi escondida.\n\nSua essência pede uma presença que não invade. Ela contém. Não domina. Sustenta.",
    dinamica:
      "Seu funcionamento interno segue uma lógica muito específica: Perséfone percebe profundamente; Deméter responde cuidando.\n\nPrimeiro você sente. Depois acolhe. Primeiro capta. Depois tenta reparar, proteger, suavizar ou sustentar.\n\nEssa estrutura é bonita, mas pede maturidade emocional, porque você tende a se envolver com facilidade na dor, na necessidade e na vulnerabilidade do outro.",
    percebida:
      "Sua presença tende a ser lida como doce, empática, acessível, confiável, acolhedora e emocionalmente segura.\n\nAs pessoas sentem que podem relaxar perto da sua energia. Ao mesmo tempo, Perséfone adiciona profundidade, recolhimento e uma delicadeza que não se entrega inteira de imediato.",
    sombra:
      "A sombra dessa combinação aparece quando sensibilidade e cuidado deixam de ser expressão de essência e passam a se tornar mecanismo de sobrevivência emocional.\n\nPerséfone pode absorver o ambiente e perder contorno. Deméter pode cuidar excessivamente e sustentar vínculos além do saudável.\n\nA sombra surge como autoabandono emocional: quando o cuidado substitui o próprio eu.",
    padraoRelacional:
      "Nos vínculos, você tende a perceber profundamente o outro, criar conexão emocional com rapidez, se envolver pelo cuidado e sustentar o vínculo com presença afetiva.\n\nO principal risco é ocupar o lugar de porto seguro, base emocional ou sustentação afetiva sem necessariamente ser reconhecida, escolhida ou nutrida na mesma medida.",
    caminho:
      "Seu crescimento não está em deixar de sentir nem em deixar de cuidar. Está em transformar essas qualidades em escolha consciente, e não em automatismo emocional.\n\nPerséfone consciente sente sem se dissolver. Deméter consciente cuida sem carregar.\n\nSua síntese é estar presente sem se perder e cuidar sem se abandonar.",
    essenciaImagem:
      "Sua imagem ideal não é construída para impactar. Ela é construída para acalmar, envolver e transmitir segurança emocional.\n\nSua presença estética funciona melhor quando comunica suavidade, acolhimento, delicadeza, conforto visual, verdade emocional e feminilidade serena.\n\nSua estética ideal toca antes de impressionar.",
    paleta:
      "Sua cartografia visual pede cores que acalmem, suavizem e criem sensação de proximidade emocional.\n\nBase Perséfone: lavanda, cinza claro, azul suave, rosado frio, tons enevoados, nuances etéreas e lilás apagado.\n\nAcolhimento Deméter: bege, creme, areia, terracota suave, verde claro, marrom claro e oliva suave.",
    modelagem:
      "Sua modelagem simbólica pede acolhimento, suavidade e movimento calmo: vestidos fluidos, saias suaves, blusas de caimento leve, tricôs delicados, camisas macias, peças confortáveis sem perder feminilidade e sobreposições leves.\n\nA regra central é conforto com delicadeza.",
    tecidos:
      "Seus tecidos ideais precisam parecer próximos, macios e emocionalmente seguros: algodão macio, viscose, linho suavizado, malhas leves, tricô delicado, crepe fluido, seda natural e texturas orgânicas.",
    beleza:
      "Na beleza, sua força aparece em naturalidade, delicadeza e expressão emocional. Pele natural e viçosa, olhos suaves, boca hidratada em tons rosados ou pêssego e cabelo com movimento natural sustentam sua energia.",
    presenca:
      "Sua linguagem corporal ideal comunica acolhimento com centro. Movimentos suaves, ritmo calmo, olhar empático e postura receptiva favorecem sua presença.\n\nO cuidado está em não parecer disponível para absorver tudo. Sua presença deve acolher sem se oferecer como solução para todos.",
    evitar: [
    ...
    leituraFinal:
      "Sua força não está em dominar o espaço. Está em criar segurança emocional com profundidade e verdade.\n\nA Guardiã Sensível amadurece quando entende que cuidar não precisa significar carregar, e sentir não precisa significar absorver. Sua beleza simbólica está na união entre profundidade e acolhimento: sensível sem se dissolver, doce sem se apagar, presente sem se sobrecarregar.",
    proximoPasso: proximoPassoPadrao,
  },
  ...
  "Selvagem Intuitiva": {
    ...
    reconhecimento:
      "A Selvagem Intuitiva nasce do encontro entre profundidade e liberdade. Existe em você uma presença que não se adapta facilmente a ambientes muito rígidos, invasivos ou previsíveis.\n\nPerséfone traz mundo interno, sensibilidade, intuição, silêncio e percepção das camadas invisíveis. Artemis traz autonomia, instinto, território e movimento.\n\nJuntas, elas formam uma mulher que precisa preservar seu espaço interno e externo.",
    essencia:
      "A Selvagem Intuitiva une a percepção subterrânea de Perséfone com o instinto livre de Artemis.\n\nVocê não caminha apenas pela lógica externa. Precisa sentir que algo faz sentido por dentro. Sua essência não aceita domesticação emocional.\n\nSua imagem precisa traduzir mistério livre: profundidade com movimento, sensibilidade com autonomia, intuição com território.",
    dinamica:
      "Seu funcionamento interno alterna entre recolhimento e movimento. Perséfone percebe, sente e mergulha. Artemis se desloca, preserva espaço e busca liberdade.\n\nVocê pode precisar de silêncio para entender o que sente e de movimento para não se sentir presa.\n\nO desafio é não transformar proteção em fuga.",
    percebida:
    ...
    sombra:
      "A sombra da Selvagem Intuitiva aparece quando sensibilidade e autonomia viram mecanismo de defesa.\n\nPerséfone pode se recolher demais. Artemis pode fugir de vínculos e rejeitar qualquer demanda.\n\nA sombra central é desaparecer antes de ser tocada. A cura está em perceber que nem toda aproximação é invasão.",
    padraoRelacional:
      "Nos vínculos, você precisa de profundidade e espaço. Relações superficiais não te nutrem, mas relações sufocantes também não sobrevivem dentro de você.\n\nO risco é testar o vínculo pela distância. Seu amadurecimento relacional está em comunicar sua necessidade de espaço sem desaparecer.",
    caminho:
      "Seu caminho está em integrar profundidade e liberdade sem transformar uma em defesa da outra.\n\nPerséfone consciente sente sem se dissolver. Artemis consciente sustenta autonomia sem fugir.\n\nSua síntese é sentir profundamente sem desaparecer, ser livre sem fugir e pertencer a si mesma sem recusar todo vínculo.",
    essenciaImagem:
      "Sua imagem ideal mistura mistério, natureza e liberdade. Ela precisa parecer viva, intuitiva e não domesticada.\n\nNo Produto 1, seus primeiros códigos visuais são textura natural, movimento, camadas, tons profundos ou terrosos, assimetria, elementos orgânicos e uma estética que sugere mundo interno.",
    paleta:
